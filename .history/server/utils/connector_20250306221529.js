 ...
 * @LastEditTime: 2025-03-06 22:15:29
...
class Connector {
    ...
    async query(querys) {
        try {
            ...
            // 校验time参数
            const time = querys.time === 'week' ? 'week' : 'month';
            const days = time === 'week' ? 7 : 30;
            const tableName = time === 'week' ? 'TFU_PASSENGERS' : 'TFU_PASSENGERS_HISTORY';
            ...
            conditions.push('FLIGHT_DATE >= TRUNC(SYSDATE) - :days');
