 ...
 * @LastEditTime: 2025-03-13 12:18:31
  ...
  <div class="container">
    <el-container>
      ...
      <el-main class="main-wrapper">
        ...
        <!-- 验证信息卡片 -->
        <el-card shadow="hover" class="table-card">
          <el-table :data="verifyData" stripe empty-text="点击上方乘客姓名查看验证信息">
            ...
            <el-table-column label="证件照片">
              <template #default="scope">
                <!-- <el-image
                  ...
                  hide-on-click-modal
                > -->
                <el-image style="width: 100px; height: 100px" :src="`http://10.33.113.23:8002${scope.row.PASS_PHOTO}`" :zoom-rate="1.2" :max-scale="7"
                  :min-scale="0.2" :preview-src-list="[`http://10.33.113.23:8002${scope.row.PASS_PHOTO}`]" show-progress :initial-index="4" fit="cover">
                  <template #error>
