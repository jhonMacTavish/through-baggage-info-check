 ...
 * @LastEditTime: 2025-03-12 13:05:56
    ...
    <el-container>
      ...
      <el-main>
        <el-table :data="tableData" style="width: 100%">
          ...
          <el-table-column prop="FLIGHT_NO" label="FLIGHT_NO" width="180" />
          <el-table-column prop="ID_CARD" label="ID_CARD" />
          <el-table-column prop="TERMINALL" label="TERMINALL" />
          ...
          <el-table-column prop="CHECKIN_AGENT
" label="CHECKIN_AGENT
" />
          <el-table-column prop="CHECKIN_OFFCIE
" label="CHECKIN_OFFCIE
" />
        </el-table>
      </el-main>
    </el-container>
