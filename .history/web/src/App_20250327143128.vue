 ...
 * @LastEditTime: 2025-03-27 14:31:14
      ...
      <el-main class="main-wrapper">
        ...
        <el-card shadow="hover" class="table-card">
          <el-skeleton :loading="loading" :rows="6" animated>
            <el-table id="educe-table" :data="passengerData" stripe highlight-current-row @row-click="queryVerify"
              empty-text="暂无乘客数据">
            ...
            <el-table-column label="证件照片">
              <template #default="scope">
                <el-image style="width: 100px; height: 100px" :src="`http://10.33.113.23:8002${scope.row.PASS_PHOTO}`"
                  ...
                  :initial-index="4" fit="cover" :z-index="9999">
                  <template #error>
